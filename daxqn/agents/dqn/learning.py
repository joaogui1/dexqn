...
from acme.jax.snapshotter import JAXSnapshotter
...
class DQNLearner(acme.Learner, tf_savers.TFSaveable):
  """DQN learner.
  ...
  def __init__(
    ...
    if snapshot:
      self._snapshotter = JAXSnapshotter(
